        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">
              إدارة محادثاتك ورسائلك مع المستفيدين والإدارة
            </p>
          </div>
              ...
              <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="flex gap-1">
                  ...
                  <button
                    ...
                    class="flex-1 px-3 py-1 text-xs rounded-lg transition-colors"
                    :class="currentFilter === 'users' ? 'bg-[#1B3C53] text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'"
                  >
                    مستفيدين
                  </button>
                </div>
                      ...
                      <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-1">
                          <span 
                            ...
                            :class="conversation.priority === 'high' ? 'bg-red-500' : 'bg-yellow-500'"
                          ></span>
                          <span
            ...
            <div class="lg:col-span-3 flex flex-col">
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      :title="selectedConversation.priority === 'high' ? 'إزالة الأولوية' : 'تعيين أولوية عالية'"
                    >
                      <span class="material-icons" :class="selectedConversation.priority === 'high' ? 'text-yellow-500' : ''">
                        flag
                      </span>
                    </button>
                    <button
              ...
              >
                ...
                <p class="text-gray-500 dark:text-gray-500 max-w-md">
                  اختر محادثة من القائمة لبدء المراسلة أو ابدأ محادثة جديدة مع المستفيدين أو الإدارة
                </p>
              </div>
            </div>
          </div>
  ...
  setup() {
    ...
    const stats = computed(() => {
      ...
      return {
        ...
        unreadMessages,
        activeChats,
        avgResponseTime: 15 // محاكاة - في التطبيق الحقيقي يتم حسابها من البيانات
      }
    })
    ...
    const filteredConversations = computed(() => {
      ...
      } else if (currentFilter.value === 'users') {
        filtered = filtered.filter(conv => conv.participant.role === 'user')
      }
    ...
    const adminRecipients = computed(() => 
      availableRecipients.value.filter(user => user.role === 'admin')
    )
    ...
    const selectConversation = (conversation) => {
      ...
      router.push(`/employee/messages/${conversation.id}`)
    ...
    const createNewConversation = () => {
      ...
      const conversation = {
        ...
        priority: markAsImportant.value ? 'high' : null
      }
    ...
    const togglePriority = () => {
      if (selectedConversation.value) {
        selectedConversation.value.priority = selectedConversation.value.priority === 'high' ? null : 'high'
        saveConversations()
      }
    }
