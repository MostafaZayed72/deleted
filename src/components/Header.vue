    ...
    <div class="container mx-auto px-6 py-4">
      ...
      <div class="flex items-center justify-between">
        ...
        <router-link to="/" class="flex items-center gap-3 hover:opacity-80 transition-all duration-300 transform hover:scale-105 group">
          ...
          <div class="w-12 h-12 rounded-2xl flex items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500 shadow-lg overflow-hidden custom-rotate group-hover:rotate-12 transition-transform duration-500">
            <img 
              v-if="systemLogo" 
              :src="systemLogo" 
              alt="شعار النظام"
